...
EvtPinListener::EvtPinListener(int pin, int debounce, bool targetValue, EvtAction action, int data) {
  this->pin = pin;
...
EvtPinListener::EvtPinListener(int pin, EvtAction action, int data) {
  this->pin = pin;
  this->triggerAction = action;
  this->extraData = &data;
}
